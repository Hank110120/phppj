...
<html>
  ...
  <form method="POST"  action="messageteacherjoin.php" class="wow bounceIn" style="position: relative;top: 60px;">
  ...
  <div class=" flexbox" id="app">
      <div class=" item">
        <div class="form-group">
            <label for="SC_CN">Classroom</label>
      ...
      <div class=" item">
        <div class="form-group">
          ...
          <textarea type="text" class="form-control" id="news" name="news" rows="5" required style="font-size:24px"></textarea>
        </div>
      </div>
      <div class=" item">
        <div class="cen" >
