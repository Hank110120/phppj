<?php
include '../transcript/childselect.php';
...
<form method="POST"  action="childjoin.php" class="wow bounceIn" style="position: relative;top: 60px;">
...
<nav class="navbar fixed-top navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
  ...
  <div class="form-group">
      ...
      <input type="text" class="form-control" name="UA_PL" id="UA_PL" readonly="readonly" value="2" style="font-size:24px">
  </div>
  ...
  <div class="form-group">
      <label for="S_Name">Child Name</label>
      <input type="text" class="form-control" name="S_Name" id="S_Name" placeholder="Enter Child Name" style="font-size:24px">
  </div>
  <div class="form-group">
      <label for="UA_Name">Parents Name</label>
      <input type="text" class="form-control" id="UA_Name" name="UA_Name" placeholder="Enter Parents Name" style="font-size:24px">
  </div>
  <div class="form-group">
      <label for="S_Phone">Parents Phone (Account) </label>
      <input type="text" class="form-control" id="S_Phone" name="S_Phone" placeholder="Enter Parents Phone" style="font-size:24px">
  </div>
  <div class="form-group">
