...
<body background="../IMAGES/anna-kolosyuk-481877-unsplash.jpg" style=" background-repeat:no-repeat ;background-size:100% 100%; background-attachment: fixed;">
...
<div class="bg" >
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
    ...
    <div class="form-group">
        <label for="SC_CI">Class Name</label>
                <select class="form-control" name="SC_CI" id="SC_CI" style="font-size:24px;height:50px;">
...
?>
    ...
    <div class="form-group">
        <label for="F_SId">Student Name</label>
        <input type="text" class="form-control" id="F_SId" name="F_SId" style="font-size:24px">
    </div>
    <div class="form-group">
        <label for="F_Subject">Subject</label>
        <input type="text" class="form-control" name="F_Subject" id="F_Subject" style="font-size:24px">
    </div>
    <div class="form-group">
